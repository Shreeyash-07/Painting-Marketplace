    ...
    <div className={Style.upload}>
      ...
      <div className={Style.upload_box}>
        <div className={formStyle.Form_box_input}>
          <label htmlFor="nft" style={{ marginLeft: "0px" }}>
            Painting Name
          </label>
          <input
            type="text"
        ...
        {/* <div className={formStyle.Form_box_input}>
          <label htmlFor="website" style={{ marginLeft: "0px" }}>
            Website
          </label>
          <div className={formStyle.Form_box_input_box}>
            <div className={formStyle.Form_box_input_box_icon}>
              <MdOutlineHttp style={{ fontFamily: "inherit" }} />
            </div>
        ...
        <div className={formStyle.Form_box_input}>
          <label htmlFor="description" style={{ marginLeft: "0px" }}>
            Description
          </label>
          <textarea
            name=""
        ...
        */}
        <div className={formStyle.Form_box_input}>
          <label htmlFor="Price" style={{ marginLeft: "0px" }}>
            Price
          </label>
          <div className={formStyle.Form_box_input_box}>
            <div className={formStyle.Form_box_input_box_icon}>
